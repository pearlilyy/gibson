...
class User(db.Model):
    ...
    guitar_type = db.Column(db.String(10))
    city = db.Column(db.String(10))

    def __init__(self, username: str, password: str, first_name: str, last_name: str, email: str, phone: str, reg_date: datetime, guitar_type: str, city: str):
...
class Fix(db.Model):
    ...
    attached_file = db.Column(db.String(30))
    post_date = db.Cloumn(db.DateTime, nullable=False,
                          default=datetime.datetime.utcow)

    def __init__(self, user_id: int, guitar_info: str, attached_file: str, post_date: datetime):
